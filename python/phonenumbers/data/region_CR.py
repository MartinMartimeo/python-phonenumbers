...
PHONE_METADATA_CR = PhoneMetadata(id='CR', country_code=506, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='5(?:0[0-4]|7[01])\\d{5}|[67][0-2]\\d{6}|8[3-9]\\d{6}', possible_number_pattern='\\d{8}', example_number='83123456'),
    ...
    national_prefix_for_parsing='(19(?:0[0-2468]|19|66|77))',
